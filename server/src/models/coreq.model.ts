...
import type { Req, ReqId } from "./req.model";
...
export type CoreqCreationAttributes = Optional<
  CoreqAttributes,
  CoreqOptionalAttributes
>;

export class Coreq
  extends Model<CoreqAttributes, CoreqCreationAttributes>
  implements CoreqAttributes
{
  id!: number;
  prereq_id?: number;
  precoreq_id?: number;
