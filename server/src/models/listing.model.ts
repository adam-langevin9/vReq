...
import type { Course, CourseId } from "./course.model";
import type { Node, NodeId } from "./node.model";
import type { Visual, VisualId } from "./visual.model";
  ...
  implements ListingAttributes
{
  ...
  setVisual_id_visuals!: Sequelize.BelongsToManySetAssociationsMixin<
    Visual,
    VisualId
  >;
  addVisual_id_visual!: Sequelize.BelongsToManyAddAssociationMixin<
    Visual,
    VisualId
  >;
  addVisual_id_visuals!: Sequelize.BelongsToManyAddAssociationsMixin<
    Visual,
    VisualId
  >;
  createVisual_id_visual!: Sequelize.BelongsToManyCreateAssociationMixin<Visual>;
  removeVisual_id_visual!: Sequelize.BelongsToManyRemoveAssociationMixin<
    Visual,
    VisualId
  >;
  removeVisual_id_visuals!: Sequelize.BelongsToManyRemoveAssociationsMixin<
    Visual,
    VisualId
  >;
  hasVisual_id_visual!: Sequelize.BelongsToManyHasAssociationMixin<
    Visual,
    VisualId
  >;
  hasVisual_id_visuals!: Sequelize.BelongsToManyHasAssociationsMixin<
    Visual,
    VisualId
  >;
