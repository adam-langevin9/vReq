...
export class Visual extends Model<VisualAttributes, VisualCreationAttributes> implements VisualAttributes {
  ...
  setListing_id_listings!: Sequelize.BelongsToManySetAssociationsMixin<Listing, ListingId>;
  addListing_id_listing!: Sequelize.BelongsToManyAddAssociationMixin<Listing, ListingId>;
  addListing_id_listings!: Sequelize.BelongsToManyAddAssociationsMixin<Listing, ListingId>;
  createListing_id_listing!: Sequelize.BelongsToManyCreateAssociationMixin<Listing>;
  removeListing_id_listing!: Sequelize.BelongsToManyRemoveAssociationMixin<Listing, ListingId>;
  removeListing_id_listings!: Sequelize.BelongsToManyRemoveAssociationsMixin<Listing, ListingId>;
  hasListing_id_listing!: Sequelize.BelongsToManyHasAssociationMixin<Listing, ListingId>;
  hasListing_id_listings!: Sequelize.BelongsToManyHasAssociationsMixin<Listing, ListingId>;
