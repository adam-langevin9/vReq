...
<template>
  ...
  <div v-if="!user.id" class="flex flex-column gap-5">
    ...
    <div class="flex justify-content-center flex-grow-1">
      <span class="p-float-label">
        <PrimePassword id="pwd" class="w-full keep-style" v-model="pwd" :toggleMask="true" :feedback="false" />
    ...
    <div class="flex justify-content-center flex-grow-1">
      <span class="p-float-label">
        <PrimePassword id="new-pwd" class="w-full keep-style" v-model="newPwd" :toggleMask="true" :feedback="false" />
